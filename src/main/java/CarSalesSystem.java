...
public class CarSalesSystem extends JFrame implements ActionListener, ComponentListener, ChangeListener
{
	...
	public CarSalesSystem(String f)
	{
		...
		{
			logger.log(Level.WARNING, "The data file, 'cars.dat' doesn't exist. Plase create an empty file named 'cars.dat'");
			System.exit(0);
		}
		// empty cars.dat file, this error should be ignored
		catch (java.io.IOException exp)
		{
			logger.log(Level.WARNING, "The data file, 'cars.dat' is possibly corrupted. Please delete it and create a new empty data file named cars.dat");
			System.exit(0);
		}
		catch (Exception exp)
		{
			logger.log(Level.WARNING, "There was an error loading 'cars.dat'. Try deleting and creating a new empty file named 'cars.dat'");
			System.exit(0);
		}
